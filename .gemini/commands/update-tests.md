...
## Process
1. Read `docs/testing.md` for testing guidelines (if available).
...
make test-parallel     # Run tests in parallel (faster, uses pytest-xdist)
...
- Mock external dependencies (APIs, databases, browsers).
