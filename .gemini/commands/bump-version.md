...
## Process
1. Read `GEMINI.md` and `docs/versioning.md` for versioning rules.
...
## Version Locations
- `pyproject.toml` - Main project version (Primary).
- `src/scraper/amazon/__init__.py` - Scraper module version.
