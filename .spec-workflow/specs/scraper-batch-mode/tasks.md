...
- [x] 2. Extend YAML configuration schema
...
- [x] 3. Create BatchController class
...
- [x] 4. Add CLI arguments for batch mode
...
- [x] 5. Integrate BatchController into CLI main()
  - Files: `src/scraper/amazon/scraper.py` (modify main() function)
...
- [x] 6. Create unit tests for BatchController
...
- [x] 7. Create integration tests for end-to-end batch scraping
