...
class TestTrendAwareHashtagGenerator:
    ...
    async def test_merge_trending_tags_caching(self, generator):
        ...
        with patch.object(
            StaticTrendProvider, "get_trending_tags", wraps=StaticTrendProvider().get_trending_tags
        ) as mock_get:
    ...
    async def test_merge_trending_tags_api_failure(self, generator):
        ...
        generator.provider.get_trending_tags = AsyncMock(side_effect=Exception("API Error"))
