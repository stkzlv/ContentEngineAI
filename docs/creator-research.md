...
5. **Put motion on every still.** TikTok's Creator Rewards criteria name "low-quality images, or slide videos", and its feed standards exclude minimally edited content. Slow, varied motion on every image is close to mandatory.
...
- **Ranking inputs (A).** Whether the viewer chose to watch or swiped away, the share of viewers who viewed, average view duration and percentage viewed, likes, and survey responses. Videos are "ranked based on performance and viewer personalization". https://support.google.com/youtube/answer/11914225
...
- **Views were redefined (A).** Since 31 March 2025 every play and replay counts as a Shorts view. The older measure is now "engaged views", which monetisation uses. Raw Shorts view counts are inflated by loops, so judge performance on engaged views and swipe-away. https://support.google.com/youtube/thread/333869549
...
- **Custom Shorts thumbnails (A).** Partner Program creators can upload custom Shorts thumbnails since July 2026. Where they display is not stated in the announcement; the swipe feed autoplays the video itself. https://blog.youtube/news-and-events/youtube-studio-custom-thumbnail-updates/

### TikTok

- **Ranking inputs (A).** User interactions, video information (captions, sounds, hashtags) and device settings. Finishing a longer video carries more weight than weak signals. Follower count and past hits are "not direct factors" (2020 statement). https://newsroom.tiktok.com/en-us/how-tiktok-recommends-videos-for-you
...
- **For You feed eligibility (A).** Reused content without creative edits (such as another creator's watermark or logo), low-quality or minimally edited content (such as short clips made only from GIFs), and engagement manipulation ("like-for-like" promises, false incentives for gifting or following, misleading claims meant to boost views) are ineligible. The current guidelines took effect on 24 September 2026. https://www.tiktok.com/community-guidelines/en/fyf-standards
- **AI content (A).** A label is required for AI or edits that show realistic people or scenes, and for audio that mimics a real person. The 2026-H2 guidelines say disclosure is not needed for "generic text-to-speech (TTS) narration, when the TTS isn't a recognizable voice of a known individual." https://www.tiktok.com/community-guidelines/en/integrity-authenticity In November 2025 TikTok began testing a control that lets viewers see less AI content; where it applies, a labelled video's reachable audience shrinks by however many viewers turn it down. https://newsroom.tiktok.com/more-ways-to-spot-shape-and-understand-ai-content?lang=en
...
- **Top signals (B, secondary).** Adam Mosseri, as quoted: watch time, likes per reach and sends per reach. https://blog.hootsuite.com/instagram-algorithm/
...
- **AI disclosure costs a little engagement (A).** A study of about one million TikTok posts found AI disclosure cut engagement by 7-8%, through weaker parasocial connection, driven in part by lower perceived creator effort, not quality concerns. Disclosure is still mandatory where it applies. https://academic.oup.com/jcr/advance-article/doi/10.1093/jcr/ucag013/8672493
...
- **The first seconds carry the recall (B, ads, 2021).** In TikTok's coding of its ads, the first 2 seconds matter most for ad recall and the first 2.5 seconds for awareness. https://ads.tiktok.com/business/creativecenter/quicktok/online/Power_Creative_Elements/pc/en
...
- **Length (B).** Hoyos targets 34 seconds. Galloway found Shorts with an average view duration above 50 seconds averaged 4.1 million views (2023, when Shorts were capped at 60 seconds). 30-45 seconds is defensible; lengthen only when the retention curve holds.
...
- **Motion on stills (A policy, C timing).** YouTube's inauthentic-content policy names image slideshows, and TikTok's Creator Rewards criteria name slide videos. How long a still can hold before viewers leave is unmeasured.
- **Edits count as transformation (A for originality).** Instagram counts "unique text, creative edits, and voiceover" as making content original; watermarks and speed changes do not. No retention data exists for arrows or circles.
...
- **Most TikTok viewers have sound on (B, older).** 93% of US TikTok users spend time on the platform with sound on (TikTok Marketing Science, 2020), which makes voice, music and effects at least as important as captions. https://ads.tiktok.com/business/creativecenter/quicktok/online/Power_Creative_Elements/pc/en
...
- **What drives comments is mostly bait (B, preprint, one study).** In 30 Estonian brand accounts, call-to-action type was the main comment predictor, led by engagement bait, which Meta and TikTok demote. No study isolates a genuine closing question.
...
- **"Follow for part 2" is a risk (A).** TikTok's feed standards exclude false incentives for gifting or following, so a cliffhanger that promises a payoff only for a follow is risky. An honest, self-contained series linked by YouTube's related video or a playlist is fine.
...
- AI labels kill reach. YouTube says they do not; on TikTok the cost is the viewers who turn AI content down plus a measured 7-8% engagement drop.
