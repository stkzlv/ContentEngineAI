...
A topic script is then fact-checked before anything else consumes it
...
sentences that were named, and the rewrite is kept only if it leaves the rest
of the script untouched and still passes validation. The outcome lands in
