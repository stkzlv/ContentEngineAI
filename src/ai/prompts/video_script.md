...
4.  **Exclusions:** Do NOT include emojis, hashtags, greetings, markdown formatting (like code blocks), or scene descriptions/character names in the output. The script will be used for text-to-speech generation, so keep it as clean text only without any symbols, emojis (🎶, 🚀, etc.), or hashtags (#product, #wireless, etc.). Provide the script text only. Don't use marketing language, phrases like "Game-changer", "Next-level", "Ultimate solution", "Immerse yourself".
5.  **Hook:** Start with a strong hook in the very first few seconds (aim for the first 3 seconds) to grab viewer attention immediately. Examples: "I didn’t think a $40 gadget could do that.", "Why does nobody talk about this tech?", "The algorithm doesn’t want you to find this gadget.", "I didn’t realize how much I needed this until it arrived."
