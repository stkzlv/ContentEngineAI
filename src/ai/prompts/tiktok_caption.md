# TikTok Caption Generation Instructions
...
1. **Caption Requirements:**
   ...
   - Use **exact search phrases** users would type (e.g., "affordable wireless earbuds" not "these gems will change your life")
...
2. **Hashtags:**
   ...
   - Use specific tags like #TechReview, #BudgetGadgets, #WirelessEarbuds
   - Separate with spaces
   - MUST include #ad

3. **SEO Best Practices:**
   - Think: "What would someone search for to find this product?"
   - Use natural language search phrases, not creative copy
   - Include product category, price point, use case, problem solved
   - Examples of good search phrases:
     - "wireless earbuds under $50"
     - "best budget headphones for workouts"
     - "affordable tech gadgets 2025"
...
**Complete Examples of Search-Optimized TikTok Captions:**
...
**CRITICAL:**
- Use exact search phrases users type
- NO generic hashtags (#fyp, #foryoupage, #viral, #foryou)
