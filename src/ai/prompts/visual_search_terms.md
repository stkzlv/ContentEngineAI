...
- Write what a camera can see. A stock library indexes photographs, not ideas:
  an abstract noun returns whatever else shares the word, so "network
  congestion" comes back as road traffic. Name the physical thing the
  narration is about instead.
