...
- A fork that set either key on a profile now fails at config load rather than having the value ignored, which is why this is marked breaking despite the removed code having had no caller.
