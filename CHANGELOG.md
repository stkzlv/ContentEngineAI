...
- A second research guide covers what makes short video read as AI slop and what this pipeline should avoid, with five more planned requirements; it also found that TikTok's current guidelines do not require an AI label for generic text-to-speech, which the compliance notes now flag for a decision.
