...
- The standalone pagination stopped for a dead query but not for one whose retries were spent, so a throttled keyword still opened a browser session per remaining page — straight back into the block the backoff exists to let cool.
